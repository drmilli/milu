...
const features = [
  {
    ...
    title: 'FAQ handling',
    description: 'Answer common questions instantly from your custom knowledge base — no scripting needed.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Let callers book appointments or request deliveries — without waiting on hold.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Complex calls transfer to you with a WhatsApp summary — you're always in the loop.",
  },
  {
    icon: (
    ...
    description: 'Send personalised WhatsApp messages to all contacts or targeted segments in one click.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'CRM & contacts',
    description: 'Full caller profiles with call history, orders, and appointments. Move leads through your sales pipeline.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: 'Schedule follow-up calls, WhatsApp messages, and emails so no lead ever falls through the cracks.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Every conversation is transcribed, stored, and searchable for your records.',
  },
];
