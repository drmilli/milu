...
const nav = [
  ...
  },
  {
    ...
    href: '/admin/phone-number-requests',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25h6m-3-3v6" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 11.25h9M7.5 14.25h6" />
      </svg>
    ),
  },
  {
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 flex-shrink-0 bg-primary-dark flex flex-col h-screen">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-white/10">
        <img src="/brand/wordmark.svg" alt="milu." className="h-6 w-auto mb-2" />
        <span className="text-[10px] font-bold tracking-widest uppercase text-cream/30">
          Admin Panel
        </span>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${
                active
                  ? 'bg-white/10 text-cream-light'
                  : 'text-cream/50 hover:bg-white/10 hover:text-cream/80'
              }`}
            >
