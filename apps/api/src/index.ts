...
import { handleInfobipVoiceWebhook, handleInfobipRecordingWebhook, handleInfobipVoiceInput } from './webhooks/infobip-voice';
...
app.post('/webhooks/infobip/voice', handleInfobipVoiceWebhook);
app.post('/webhooks/infobip/voice/input', handleInfobipVoiceInput);
app.post('/webhooks/infobip/voice/record', handleInfobipRecordingWebhook);
