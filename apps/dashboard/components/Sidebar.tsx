...
const nav = [
  ...
  },
  {
    ...
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-8.25-4.5-8.25 4.5m16.5 0v9l-8.25 4.5-8.25-4.5v-9m16.5 0l-8.25 4.5m0 0L3.75 7.5m8.25 4.5v9" /></svg>,
  },
  {
    label: 'Team',
    href: '/team',
